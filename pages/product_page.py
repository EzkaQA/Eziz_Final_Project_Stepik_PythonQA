...
class ProductPage(BasePage):
    ...
    def product_name_matches_added_product(self):
        ...
        assert bookName == addedProductName, \
            f"Expected book name is - {bookName}, actual book name is - {addedProductName}"
    ...
    def product_price_matches_added_product(self):
        ...
        assert bookPrice == basketTotalAfterAddingProduct, \
            f"Expected basket total is - {bookPrice}, actual basket total is - {basketTotalAfterAddingProduct}"
